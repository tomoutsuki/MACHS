#!/usr/bin/env node
/**
 * MACHS Docker Data Migration Script
...
async function main() {
  console.log('🏥 MACHS Test Data Migration');
  console.log('============================');
...
async function encryptData(data) {
  try {
    ...
    // Parse the result field which contains the actual encrypted data
    const resultData = JSON.parse(response.data.result);
    return resultData.encrypted_data;
